import { 向思源请求数据 } from '/src/components/kmindTab/src/utils'
import { http } from '/src/components/kmindTab/src/utils/http'
 ...
 * }
 */
export const createDocWithMd = (notebook: string, path: string, markdown: string) => {
