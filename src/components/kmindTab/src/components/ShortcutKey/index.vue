<template>
  <side-bar title="快捷键" :class="{ show: activeSidebar === 'shortcutKey' }">
    <div class="box">
      <div v-for="item in shortcutKeyList.zh" :key="item.type">
...
import { shortcutKeyList } from '/src/components/kmindTab/src/config'
