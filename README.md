...
- 修复思源新版DOM更新(3.1.13+)导致的显示bug

### v2.1.4(2024年5月23日)

注意：

- 以下新增的功能依赖思源的最新api，请保证你的思源在v3.0.15+版本

新增：

- 支持配置knote插入位置：可以选择默认插入到当日日记的顶部 or 底部，默认底部。修改指引：右侧KNote dock栏，设置图标->插入位置

### v2.1.3(2024年5月17日)

修复：

- 修复思源跨日的时候，KNote的快捷输入框会插入内容到前一天的日记中的bug

新增：

- 新增当今天没有日记的时候，使用KNote的快捷输入框记录内容的时候会自动创建当天的日记
...
- 国际化支持，目前支持中文和英文，[#6](https://github.com/suka233/siyuan-knote/issues/6)
